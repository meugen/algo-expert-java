...
public class SymmetricalTreeTest {
    ...
    private static void internalTestCase(SymmetricalTree solution, SymmetricalTree.BinaryTree tree, boolean expected) {
        var result = solution.symmetricalTree(tree);
